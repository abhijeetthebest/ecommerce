...
<template:insert template='/ecomTemplate.jsp'>
  ...
  <template:put name='navList' content='[["maintain customer", ""], ["order history",""], ["add entry",""]]' direct='true'/>
  ...
  <template:put name='content' content='/customer/addOrderHistoryContent.jsp'/>
