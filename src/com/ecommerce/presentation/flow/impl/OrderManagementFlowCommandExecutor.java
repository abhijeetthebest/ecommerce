...
/**
 * Flow command executor for order management.
 */
public class OrderManagementFlowCommandExecutor implements FlowCommandExecutor {
    
    private Map<String, String> actionViewMap;
    
    /**
     * Construct a new order management flow command executor.
     */
    public OrderManagementFlowCommandExecutor() {
        actionViewMap = new HashMap<>();
        
        // Configure action views
        actionViewMap.put("CreateOrder", "/order/createOrder.jsp");
